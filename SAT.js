...
(function (root, factory) {
    ...
    // you are going to reuse a single CollisionResponse object for multiple intersection tests (recommented
     ...
     * @param {Response=} response A CollisionResponse object (optional) which will be populated
     ...
     * @param {Response=} response CollisionResponse object (optional) that will be populated if
